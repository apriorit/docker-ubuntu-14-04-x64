...
RUN apt-get install -y libxext-dev libxfixes-dev libxft-dev libxi-dev libxrandr-dev libxrender-dev libxv-dev libxkbfile-dev
RUN apt-get install -y libxkbfile1 libxkbfile-dev squashfs-tools desktop-file-utils git-core libssl-dev libxinerama-dev libxdamage-dev 
...
RUN /tmp/docker/install-qt.sh amd64
