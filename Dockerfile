...
RUN cd /tmp && wget https://archive.apache.org/dist/thrift/0.9.0/thrift-0.9.0.tar.gz && tar xf thrift-0.9.0.tar.gz && cd thrift-0.9.0 && ./configure CXXFLAGS="-DHAVE_NETINET_IN_H" && make install && rm -rf thrift-0.9.0 thrift-0.9.0.tar.gz
